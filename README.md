...
这是华为 ICT 创新赛项目的全新开发仓库。项目面向高校实习/校招用户，以目标 JD 为入口，完成官方岗位发现、岗位—能力—证据建模、自适应文本测评、靶向面试、差距驱动学习、复测和证据化简历建议。

## 云码道开发入口

开始任何开发任务前，请先阅读：

1. [云码道总规格](./shared_docs/00-codeartsdoer-master.md)
2. [项目文档索引](./shared_docs/README.md)
